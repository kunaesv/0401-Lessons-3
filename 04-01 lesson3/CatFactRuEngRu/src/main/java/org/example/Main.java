...
public class Main {
    private static final String BASE_URL = "https://catfact.ninja/fact";
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
            ...
            CompletableFuture<Void> future = CompletableFuture.runAsync(() -> {
                try {
                    ...
                    String text = jsonResponse.getString("fact");
                    System.out.println(Translator(text));
                    System.out.println(TranslatorBack(Translator(text)));
    ...
    private static String TranslatorBack(String text) throws Exception {
